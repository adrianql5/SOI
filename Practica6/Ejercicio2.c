...
int main(int argc, char *argv[]) {
    ...
    // Al usar MAP_SHARED, los cambios en la proyección en memoria se reflejarán en el archivo
    ...
    // Si no sincronizamos despues de modificar la memoria mapeado, los cambios que se realicen
    //podrían no ser inmediatamente escritos en el disco, o pueden perderse si el programa termina antes
    // de que el sistema operativo decida escribir los cambios.
